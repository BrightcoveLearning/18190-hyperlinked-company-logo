...
# 18190-hyperlinked-company-logo
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-hyperlinked-company-logo.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>company-logo.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>company-logo.css</strong>.</td>
    </tr>
  </tbody>
</table>
